...
from .parts.agents.util import valuation
...
class KPIs:
    def __init__(self, time_step: int):
        ...
        self._traders_revenue_per_tick: List[float] = []
        self._trade_per_tick: List[float] = []
        self._LP_WhitePool_per_tick: List[float] = []
        self._LP_GreyPool_per_tick: List[float] = []

    def takeStep(self, state, agents):   
        pass     
        # self._traders_revenue_per_tick.append(
        #     state.traderRevenueAtTick(agents))
